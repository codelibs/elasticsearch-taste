...
public final class NullRescorer<T> implements Rescorer<T>, IDRescorer {
     ...
     */
    @Override
    public double rescore(final T thing, final double originalScore) {
        return originalScore;
    }

    @Override
    public boolean isFiltered(final T thing) {
        return false;
    }

    @Override
    public double rescore(final long id, final double originalScore) {
        return originalScore;
    }

    @Override
    public boolean isFiltered(final long id) {
        return false;
    }
