...
public final class GenericItemSimilarity implements ItemSimilarity {
     ...
     */
    public GenericItemSimilarity(final Iterable<ItemItemSimilarity> similarities) {
    ...
    public GenericItemSimilarity(
            final Iterable<ItemItemSimilarity> similarities, final int maxToKeep) {
        final Iterable<ItemItemSimilarity> keptSimilarities = TopItems
    ...
    public GenericItemSimilarity(final ItemSimilarity otherSimilarity,
        ...
        final long[] itemIDs = GenericUserSimilarity
                .longIteratorToList(dataModel.getItemIDs());
        final Iterator<ItemItemSimilarity> it = new DataModelSimilaritiesIterator(
    ...
    private void initSimilarityMaps(
            final Iterator<ItemItemSimilarity> similarities) {
    ...
    public double itemSimilarity(final long itemID1, final long itemID2) {
        ...
        final FastByIDMap<Double> nextMap = similarityMaps.get(firstID);
        if (nextMap == null) {
            return Double.NaN;
        }
    ...
    private static final class DataModelSimilaritiesIterator extends
            AbstractIterator<ItemItemSimilarity> {
