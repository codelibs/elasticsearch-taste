...
public final class FastByIDMap<V> implements Serializable, Cloneable {
    ...
    public FastByIDMap(final int size) {
        this(size, NO_MAX_SIZE);
    }

    public FastByIDMap(final int size, final float loadFactor) {
        this(size, NO_MAX_SIZE, loadFactor);
    }

    public FastByIDMap(final int size, final int maxSize) {
    ...
    public boolean equals(final Object other) {
        ...
        final FastByIDMap<V> otherMap = (FastByIDMap<V>) other;
    ...
    private final class EntrySet extends AbstractSet<Map.Entry<Long, V>> {
        ...
        @Override
        public boolean add(final Map.Entry<Long, V> t) {
        ...
        @Override
        public boolean addAll(final Collection<? extends Map.Entry<Long, V>> ts) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class ValueCollection extends AbstractCollection<V> {
        ...
        @Override
        public boolean addAll(final Collection<? extends V> vs) {
            throw new UnsupportedOperationException();
        }
