...
public final class FastMap<K, V> implements Map<K, V>, Serializable, Cloneable {
    ...
    public FastMap(final Map<K, V> other) {
        this(other.size());
        putAll(other);
    }
    ...
    public boolean equals(final Object other) {
        ...
        final FastMap<K, V> otherMap = (FastMap<K, V>) other;
    ...
    private final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        @Override
        public boolean add(final Entry<K, V> t) {
        ...
        @Override
        public boolean addAll(final Collection<? extends Entry<K, V>> ts) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractSet<K> {
        ...
        @Override
        public boolean addAll(final Collection<? extends K> ts) {
            throw new UnsupportedOperationException();
        }
