...
public final class PlusAnonymousConcurrentUserDataModel extends
    ...
    public PreferenceArray getPreferencesForItem(final long itemID) {
        ...
        final List<Preference> anonymousPreferences = Lists.newArrayList();

        for (final Map.Entry<Long, PreferenceArray> prefsMap : tempPrefs
                .entrySet()) {
    ...
    public int getNumUsersWithPreferenceFor(final long itemID) {
        ...
        for (final Map.Entry<Long, PreferenceArray> singleUserTempPrefs : tempPrefs
                .entrySet()) {
