 ...
 */
public final class MemoryIDMigrator extends AbstractIDMigrator implements
        UpdatableIDMigrator {
    ...
    @Override
    public void storeMapping(final long longID, final String stringID) {
    ...
    @Override
    public String toStringID(final long longID) {
        synchronized (longToString) {
    ...
    @Override
    public void initialize(final Iterable<String> stringIDs) {
