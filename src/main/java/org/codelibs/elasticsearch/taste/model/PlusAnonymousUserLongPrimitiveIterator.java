...
import org.codelibs.elasticsearch.taste.common.AbstractLongPrimitiveIterator;
import org.codelibs.elasticsearch.taste.common.LongPrimitiveIterator;

final class PlusAnonymousUserLongPrimitiveIterator extends
    ...
    PlusAnonymousUserLongPrimitiveIterator(
            final LongPrimitiveIterator delegate, final long extraDatum) {
    ...
    public long nextLong() {
        if (datumConsumed) {
            ...
            if (delegate.hasNext()) {
                final long delegateNext = delegate.peek();
