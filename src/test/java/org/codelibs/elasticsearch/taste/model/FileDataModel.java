...
import org.codelibs.elasticsearch.taste.common.iterator.FileLineIterator;
...
public class FileDataModel extends AbstractDataModel {
     ...
     */
    public FileDataModel(File dataFile, String delimiterRegex)
            throws IOException {
    ...
    protected void processFile(FileLineIterator dataOrUpdateFileIterator,
            FastByIDMap<?> data, FastByIDMap<FastByIDMap<Long>> timestamps,
            ...
            if (!hasTimestamp && preferenceValueString.isEmpty()) {
                ...
                if (!exists) {
                    if (prefs == null) {
                        ...
                        ((FastByIDMap<Collection<Preference>>) data).put(
                                userID, prefs);
                    }
                    prefs.add(new GenericPreference(userID, itemID,
                            preferenceValue));
                }
    ...
    protected void processFileWithoutID(
            FileLineIterator dataOrUpdateFileIterator,
    ...
    private void addTimestamp(long userID, long itemID, String timestampString,
            FastByIDMap<FastByIDMap<Long>> timestamps) {
     ...
     * which subclasses can inject an {@link org.codelibs.elasticsearch.taste.model.IDMigrator} to perform
     * translation.
     */
